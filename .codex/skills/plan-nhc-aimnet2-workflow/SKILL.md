...
- Distinguish AIMNET2_CONVERGED, AIMNET2_CLOSE_TO_PURE_PYSCF, and SINGLE_POINT_ONLY_ELIGIBLE. Never infer the latter two from Fmax alone.
...
- Never kill, pause, or displace VASP or other user work. Idle capacity is not authority to add an unregistered candidate.
...
- delete, move, rename, clean, or overwrite data, including VASP WAVECAR or CHGCAR;
